...
var switchbutton = `<button class="switch_submit anon_submit" onclick="switchposttype()">Hello World</button>`
$('#pagelet_composer ._ei_ > div.clearfix').prepend(switchbutton);
var container = `<div style="margin:10px;padding:10px;"><h1>YO YO YO</h1></div>`;
$('#pagelet_composer').prepend(container);
var input = `
  <div class="anon_compose">
    <div>
      <span class="anon_input" contenteditable="true">What's on your mind?</span>
